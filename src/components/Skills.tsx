...
const Skills: React.FC = () => {
  const [ref, isVisible, isActive, hasBeenVisible, visibilityProgress] = useProgressiveVisibility('skills', 0.05);
  ...
  return (
    <section id="skills" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollAnimatedSection className="text-center mb-16" sectionId="skills" enhancedScrollDown={true}>
          <DynamicHeading
            level="h2"
                      ...
                      >
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                          <motion.div
                            ...
                            initial={{ width: 0 }}
                            animate={{ width: isVisible ? `${skill.level}%` : '10%' }}
                            transition={{ duration: 1.2, delay: categoryIndex * 0.1 + skillIndex * 0.05 }}
                          >
                            <motion.div
                        ...
                        <motion.span
                          ...
                          transition={{ delay: categoryIndex * 0.1 + skillIndex * 0.05 + 0.8 }}
                        >
                          {skill.level}%
                        </motion.span>
        ...
        <ScrollAnimatedSection direction="up" delay={0.4} className="mt-20" sectionId="skills" enhancedScrollDown={true}>
          <motion.div
                  ...
                  <div className="relative w-32 h-32 mx-auto mb-6">
                    <svg className="w-32 h-32 transform -rotate-90">
                      ...
                      <motion.circle
                        ...
                        animate={{ 
                          strokeDashoffset: isVisible ? 2 * Math.PI * 56 * (1 - item.percentage / 100) : 2 * Math.PI * 56 * 0.9
                        }}
